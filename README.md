...
[![CI](https://github.com/yourorg/aim-protocol/workflows/CI/badge.svg)](https://github.com/yourorg/aim-protocol/actions)
...
```bash
# Clone repository
git clone https://github.com/yourorg/aim-protocol
cd aim-protocol
